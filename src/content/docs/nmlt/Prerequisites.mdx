...
2. Nhìn vào chữ `Latest`. ![image](${new URL('./assets/prerequisites/img/w64dev.png', import.meta.url)})
...
6. Bấm vào nút Start (cái nút hình Windows), ghi chữ "Edit the system variables", chọn vào cái giống hình sau ![image](${new URL('./assets/prerequisites/img/path.png', import.meta.url)})

7. Bấm vào "Environment Variables". ![image](${new URL('./assets/prerequisites/img/env.png', import.meta.url)})

8. Chọn dòng có chữ "Path" ở khu bên dưới. ![image](${new URL('./assets/prerequisites/img/system.png', import.meta.url)}) và chọn Edit.
...
VSCode, ủa cái này là editor mà? Nhưng mà nó có sẵn các extension mà bạn chỉ cần cài, config và thế là đã có luôn compiler/debugger mà không cần chạy bằng lệnh. Bạn có thể tìm hiểu tại bài viết [C/C++ for Visual Studio Code](https://code.visualstudio.com/docs/languages/cpp).
