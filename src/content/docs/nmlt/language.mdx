...
<Card title="Ngôn ngữ lập trình" icon="seti:css">
...
Ủa mà sao nãy tôi nói là số "0" và "1" mà giờ mã máy còn vừa số vừa chữ luôn vậy? Vì nó dài quá nên là họ đã encode thành hệ cơ số thập lục phân cho nó gọn, bạn muốn tìm hiểu có thể đọc bài [Hệ cơ số](/nmlt/base).
