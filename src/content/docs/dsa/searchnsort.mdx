...
### Demo
<VideoPlayer src="/docs/DSA/videos/LinearSearch.mp4" />

### Độ phức tạp
- Trường hợp tốt nhất: $O(1)$ khi mà phần tử cần tìm ngay đầu mảng.
- Trường hợp trung bình: $O(N)$ 
- Trường hợp tệ nhất: $O(N)$ khi mà nó nằm ở cuối
...
Để luyện chút tư duy thì bạn thử cải tiến để nó chạy nhanh hơn xem.
...
## Tìm kiếm nhị phân
### Ý tưởng
Tìm kiếm phần tử $A_i$ trong mảng $A$ có **thứ tự tuyến tính** (có nghĩa là nó tăng dần hoặc giảm dần) hoặc tìm giá trị $x$ lớn nhất/nhỏ nhất nào đó trong đoạn $[a, b]$ liên tiếp sao cho các giá trị nhỏ hơn/lớn hơn $x$ cũng thoả điều kiện.

Về phần thứ tự tuyến tính. Bạn thử tưởng tượng là kết quả bạn cần tìm là lớn nhất có thể, thì các giá trị nhỏ hơn đều đúng điều kiện. Giống như việc đồ thị $y = x$ có 2 nửa ở trên trục hoành và ở dưới trục hoành chẳng hạn.
...
<VideoPlayer src="/docs/DSA/videos/BinarySearch.mp4" />

### Độ phức tạp
- Trường hợp tốt nhất: $O(1)$ khi mà lần đầu là có luôn
- Trường hợp trung bình: $O(\log{N})$ 
- Trường hợp tệ nhất: $O(\log{N})$ khi chạy hết mới biết

**Lưu ý** $\log$ ở đây là logarit cơ số 2
...
### Demo
<VideoPlayer src="/docs/DSA/videos/SelectionSort.mp4" />
...
### Demo
<VideoPlayer src="/docs/DSA/videos/InsertionSort.mp4" />
[VisualAlgo](https://visualgo.net/en/sorting)
...
### Demo
<VideoPlayer src="/docs/DSA/videos/HeapSort.mp4" />
...
### Demo
<VideoPlayer src="/docs/DSA/videos/QuickSort.mp4" />
...
### Demo
<VideoPlayer src="/docs/DSA/videos/MergeSort.mp4" />
